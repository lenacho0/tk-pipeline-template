...
TABLE_DEFINITIONS = [
    ...
    },
    {
        ...
        "fields": SHOT_FIELDS,
        "views": {
            "01-分镜图生成": ["任务名称", "关联任务", "分镜序号", "画面描述", "图片提示词", "需要产品参考图", "参考资产ID列表", "分镜图生成状态", "分镜图", "分镜图错误信息"],
            "02-口播音频": ["任务名称", "关联任务", "分镜序号", "口播文本", "口播音频状态", "口播音频", "口播音频下载链接", "口播音频错误信息"],
            "03-分镜视频": ["任务名称", "关联任务", "分镜序号", "分镜图", "视频提示词", "目标时长秒", "视频通道", "视频生成模型", "视频生成状态", "分镜视频", "分镜视频URL", "视频错误信息"],
            "04-发布素材": ["任务名称", "关联任务", "分镜序号", "发布视频标题", "发布文案", "发布视频标签", "发布状态"],
            "99-排错": ["任务名称", "关联任务", "分镜序号", "错误信息", "失败分类", "分镜图错误信息", "口播音频错误信息", "视频错误信息", "结构化分镜JSON", "文本", "提示词", "视频生成原始响应JSON", "视频任务ID", "分镜图file_token", "分镜视频file_token", "口播音频FileToken", "分镜图本地路径", "本地视频路径", "口播音频路径", "发布平台", "生成时间", "分镜图生成时间", "视频生成时间"],
        },
    },
]
