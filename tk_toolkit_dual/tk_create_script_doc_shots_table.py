...
TABLE_DEFINITIONS = [
    {
        ...
        "fields": TASK_FIELDS,
        "views": {
            "01-用户入口": ["任务名称", "脚本文档标题", "脚本文档正文", "关联产品记录", "分镜风格", "视频时长", "口播音色ID", "文本AI模型", "解析AI参数JSON", "解析状态", "总分镜数", "批次ID"],
            "高级AI参数": ["任务名称", "使用统一AI路由", "文本AI模型", "解析AI参数JSON", "分镜图AI模型", "分镜图AI参数JSON", "分镜图画面尺寸", "分镜图画面比例", "尾帧图AI模型", "尾帧图AI参数JSON", "尾帧图画面尺寸", "尾帧图画面比例", "视频生成模型", "视频画面尺寸", "视频画面比例", "解析状态"],
            "99-解析排错": ["任务名称", "解析状态", "解析错误信息", "解析结果JSON", "解析后逐镜头脚本", "批次ID", "使用统一AI路由", "文本AI模型", "解析AI参数JSON", "分镜图AI模型", "分镜图AI参数JSON", "分镜图画面尺寸", "分镜图画面比例", "尾帧图AI模型", "尾帧图AI参数JSON", "尾帧图画面尺寸", "尾帧图画面比例", "视频生成模型", "视频AI参数JSON", "视频画面尺寸", "视频画面比例"],
        },
    },
    {
...
UNIFIED_TABLE_DEFINITION = {
    ...
    "views": {
        ...
        "高级AI参数": {
            "visible_fields": ["任务名称", "使用统一AI路由", "文本AI模型", "解析AI参数JSON", "参考图AI模型", "参考图AI参数JSON", "参考图画面尺寸", "参考图画面比例", "分镜图AI模型", "分镜图AI参数JSON", "分镜图画面尺寸", "分镜图画面比例", "尾帧图AI模型", "尾帧图AI参数JSON", "尾帧图画面尺寸", "尾帧图画面比例", "视频通道", "视频生成模型", "视频AI参数JSON", "视频画面尺寸", "视频画面比例"],
            "filter": {"conditions": []},
        },
        "99-排错全字段": {
