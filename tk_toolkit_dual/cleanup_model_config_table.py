...
MEDIA_DIMENSION_DEFAULTS = {
    ...
    "多图宫格图片生成": ("720x1280", "9:16"),
    "多图宫格视频生成": ("720x1280", "9:16"),
...
TASK_DEFAULT_DISPATCH_STAGE_BY_TABLE_AND_STAGE = {
    ...
    ("003-脚本文档生产表", "脚本文档结构化拆分默认"): "003新表脚本文档解析拆分",
    ("003-脚本文档生产表", "参考底图生成默认"): "003新表脚本文档参考底图生成",
    ("003-脚本文档生产表", "分镜图生成默认"): "003新表脚本文档分镜图生成",
    ("003-脚本文档生产表", "尾帧图生成默认"): "003新表脚本文档尾帧图生成",
    ("003-脚本文档生产表", "分镜视频生成默认"): "003新表脚本文档分镜视频生成",
    ("005-多图宫格视频生成表", "宫格方案生成默认"): "多图宫格方案生成",
    ("005-多图宫格视频生成表", "参考图生成默认"): "多图宫格参考图生成",
    ("005-多图宫格视频生成表", "宫格图片生成默认"): "多图宫格图片生成",
    ("005-多图宫格视频生成表", "宫格视频生成默认"): "多图宫格视频生成",
    ("005-多图九宫格视频生成表", "九宫格方案生成默认"): "多图宫格方案生成",
    ("005-多图九宫格视频生成表", "参考图生成默认"): "多图宫格参考图生成",
    ("005-多图九宫格视频生成表", "九宫格图片生成默认"): "多图宫格图片生成",
    ("005-多图九宫格视频生成表", "九宫格视频生成默认"): "多图宫格视频生成",
...
def _infer_provider(stage: str, api_base: str, model: str) -> str:
    ...
    if "otuapi" in lower_base or stage in {
        "图片生成-OTU",
        "分镜视频生成-OTU",
        "多图宫格图片生成",
        "多图宫格视频生成",
