...
- capability: 视频
- status: enabled
- endpoint: `https://api.aitgenne.com/alibailian/api/v1/services/aigc/video-generation/video-synthesis`
- payload_keys: `input, model, parameters`
- size: ``
- aspect_ratio: ``
- seconds: ``
- reference_count: `2`
...
- capability: 视频
- status: enabled
- endpoint: `https://api.aitgenne.com/v1/video/create`
- payload_keys: `aspect_ratio, enable_upsample, enhance_prompt, images, model, prompt`
- size: ``
- aspect_ratio: `9:16`
- seconds: ``
- reference_count: `2`
