...
- capability: 图片
- status: candidate
- endpoint: `https://aihubmix.com/v1/models/gpt-image-2/predictions`
- payload_keys: `input_mode, metadata, model, prompt, size`
- size: `720x1280`
- aspect_ratio: `9:16`
- seconds: ``
...
- capability: 图片
- status: candidate
- endpoint: `https://api.aitgenne.com/v1/images/generations`
- payload_keys: `input_mode, metadata, model, prompt, size`
- size: `720x1280`
- aspect_ratio: `9:16`
- seconds: ``
...
- capability: 视频
- status: enabled
- endpoint: `https://api.aitgenne.com/v1/videos`
- payload_keys: `aspect_ratio, model, prompt, seconds, size`
- size: `720x1280`
- aspect_ratio: `9:16`
- seconds: `8`
